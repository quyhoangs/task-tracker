<template>
    <div id="Main"
        class="h-auto xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 bg-white flex-col">
