<template>
        <div class="rounded-r bg-white xl:hidden flex justify-between w-full p-6 items-center ">
            ...
            <div class="flex justify-between  items-center space-x-3">
                ...
                <p class="text-2xl leading-6 text-black">Task Tracker</p>
            </div>
        ...
        <div id="Main"
            class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-white flex-col">
            <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
