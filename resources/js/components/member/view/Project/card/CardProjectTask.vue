<template>
    <div class="p-4 mt-3 flex flex-wrap -mx-4 overflow-y-auto   bg-gradient-to-r from-slate-300 to-slate-400">
        ...
        <div class="w-full md:w-1/5 p-2 max-h-screen overflow-y-auto mr-3 ">
            ...
            <!-- component -->
            <div class="border-dashed border-2 w-64 h-32 rounded flex justify-center items-center">
                <svg version="1.1" class="h-8 text-grey mr-2" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;"
                    xml:space="preserve">
                    <g>
                        <path
                ...
                <span class="block text-grey">Drop your task here</span>
            </div>
        ...
        <!-- Mô tả dự án hoặc các thành phần chart , lịch ... -->
        <div class=" md:w-1/5 p-2 max-h-screen ">
            <span class="inline-block  mr-2 px-1.5 py-0.5 rounded font-semibold">
                Mô tả dự án hoặc các thành phần chart , lịch
            </span>
        </div>
...
::-webkit-scrollbar-thumb {
    background-color: rgba(76, 68, 73, 0.5);
    border-radius: 4px;
}
