                        ...
                        @endforeach
                            <div class="card mb-3">
                                <form action="{{ $project->path() . '/tasks' }}" method="POST">
                                    @csrf
                                    <input type="text" name="body" class="w-full bg-card text-default" placeholder="Add a new task">
                                </form>
                            </div>
                </div>

                <div>
                    <h2 class="text-lg text-muted text-default font-normal mb-3">General Notes</h2>
