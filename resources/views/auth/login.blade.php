...
@section('content')
    ...
    <section class="flex flex-col md:flex-row h-screen items-center justify-center  ">
          ...
          <div class="bg-card w-full md:max-w-md  md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 ">
            ...
            @if (session('message'))
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                    ...
                    <span class="block sm:inline">{{ session('message') }}.
                    </span>
            ...
            <div class="w-full h-100 ">
                ...
                <form class="mt-6" action="/login" method="POST">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="" placeholder="Enter Email Address"
                            class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-card focus:outline-none"
                    ...
                    <div class="mt-4">
                      ...
                      focus:bg-card focus:outline-none" required
                      value="{{ old('password') }}"
                      >
                    </div>
                ...
                <button type="button"
                    class="w-full block bg-card hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
